            ...
            <div className="max-w-5xl mx-auto text-center">
              ...
              <FadeIn delay={0.2} duration={0.6}>
                <p className="text-xl lg:text-2xl text-gray-200 mb-12 max-w-3xl mx-auto">
                  ABANZOFT es un clúster digital especializado en diseñar, desarrollar e implementar soluciones digitales personalizadas para negocios y emprendedores.
                </p>
              </FadeIn>
            ...
            <div className="max-w-7xl mx-auto">
              <FadeIn>
                <div className="max-w-3xl mx-auto text-center mb-20">
                  ...
                  <p className="text-xl text-gray-600">
                    En ABANZOFT somos expertos en diseñar, desarrollar e implementar soluciones digitales personalizadas que resuelven las necesidades y problemas de nuestros clientes.
                  </p>
                </div>
              </FadeIn>
